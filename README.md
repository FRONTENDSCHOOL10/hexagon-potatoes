...
1.[ 서비스 소개](#1-서비스-소개) <br/> 2.[ 사용스택](#2-사용스택) <br/> 3.[ 발표, 피그마 링크](#3-발표-피그마-링크) <br/> 4.[ 파일 트리](#4-파일트리) <br/> 5.[ 주요 페이지 및 기능](#5-주요-페이지-및-기능)
...
<strong>Shipmate</strong>는 더 쉽고 빠른 해외직구를 도와주는 해외직구 공동구매 서비스 입니다. 쉽메이트는 복잡한 해외직구 절차를 <strong>단순화하고, 절감된 배송비로</strong> 해외상품을 구매할수 있도록 지원합니다.
...
| <b>패키지 관리</b>               | <img src="https://img.shields.io/badge/pnpm-%234a4a4a.svg?style=for-the-badge&logo=pnpm&logoColor=f69220">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| 조장                         | 스크럼마스터                                | 디자인                       | 코딩마스터 |
| ---------------------------- | ------------------------------------------- | ---------------------------- | ---------- |
| <img src="./readme/ajm.png"> | <img width="300px" src="./readme/csh.webp"> | <img src="./readme/jin.png"> |            |
...
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| <img width="350px" src="./readme/{readme 폴더에 gif넣고 파일명 여기입력하세요}"> | <img width="350px" src="./readme/{readme 폴더에 gif넣고 파일명 여기입력하세요}"> | <img width="350px" src="./readme/{readme 폴더에 gif넣고 파일명 여기입력하세요}"> |

  ...
  return (
    <Link to={`/home/instaPosting/${id}`}>
      <figure
        ...
        className="flex-[1_0_0]; flex h-[13.6rem] w-40 flex-col items-center rounded-md bg-[#FFF] shadow-shadow-blue"
      >
        <img
        ...
        <figcaption className="flex flex-col items-start gap-1 self-stretch p-2">
          ...
          <h3
            id={`post-title-${id}`}
            className="text-sub-1 w-full overflow-hidden text-ellipsis whitespace-nowrap text-black"
          >
            {content}
          </h3>
        </figcaption>
